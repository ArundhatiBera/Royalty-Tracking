    ...
    "outputs": [
      {
        ...
        "internalType": "struct RoyaltyDistribution.Stakeholder[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
...
export default RoyaltyDistributionABI;